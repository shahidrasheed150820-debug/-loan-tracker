...
A small, mobile-first loan tracker that runs entirely in a web browser. It stores loans in `localStorage`, calculates flat interest and payment balances, and supports JSON backup and restore.
